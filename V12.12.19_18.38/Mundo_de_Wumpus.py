...
class Jogo:
    ...
    def reproduzir(self, vetor_celulas, geracao):
        ...
        for contador in range(0, len(vetor_celulas), 2):
            ...
            nova_celula_a.set_tamanho(random.randint(0, 10))
            nova_celula_b.set_tamanho(random.randint(0, 10))
    ...
    def executar(self):
        ...
        for geracao in range(self.__ger):
            ...
            for agente in vet_ag:
                ...
                if agente.get_ouro() and agente.get_caminho_percorrido()[-1] == [0, 0]:
                    if len(agente.get_caminho_percorrido()) < 20:
        ...
        print(ambiente.getPoco(), "\n", ambiente.getOuro())
        print(vet_mem[0].get_caminho_percorrido())
        print(vet_mem[0].get_nice_moves())
        vet_mem[0].imprimir_agente()

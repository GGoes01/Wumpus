...
class Agente:
    ...
    def get_caminho_ouro(self):
        return self.__caminho_ouro

    def set_caminho_ouro(self, caminho):
        self.__caminho_ouro = caminho
    ...
    def imprimir_agente(self):
        print("Id: {} - Fitness: {} - Pontuação: {} - Ouro: {}\nMovimentos: {}\nCaminho Percorrido: {}"
              .format(self.__id, self.__fitness, self.__pontuacao, self.__ouro, self.__movimento, self.get_caminho_percorrido()))
    ...
    def pecado_inicial(self, celula):
        ...
        fitness = fit(penalidade, 0, 0, 0, self.__tamanho**1/2)

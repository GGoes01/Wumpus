...
class Ambiente():
    ...
    def __init__(self, tamanho):
        ...
        self.__casasPreenchidas = []  # Vetor que armazenará as casas já ocupadas por elementos
        self.__casasPocos = []  # Vetor que armazenará as casas ocupadas por poços
        self.__casaOuro = []  # Casa do ouro
        self.__casaWumpus = []  # Casa do Wumpus
